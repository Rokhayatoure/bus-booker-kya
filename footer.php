...
<footer class="footer-area section-gap">
			...
			<img class="footer-bottom" src="assets/front/img/footer-bottom.png" alt="">
		</footer>
		<!-- End footer Area -->

		<script src="assets/front/js/vendor/jquery-2.2.4.min.js"></script>
		...
		<script src="assets/front/js/hoverIntent.js"></script>
		<script src="assets/front/js/superfish.min.js"></script>
